...
<Tabs>
  <TabItem label="AI提示词">
    你可使用以下 AI 提示词来安装 Tailwind CSS 集成： ```bash 安装 Astro Tailwind
    集成 ```
  </TabItem>
...
<Tabs>
  <TabItem label="AI提示词">
    你可使用以下 AI 提示词来创建全局样式文件： ```bash 创建 Tailwind CSS
    全局样式文件 ```
  </TabItem>
  <TabItem label="参考代码">
...
<Tabs>
  <TabItem label="AI提示词">
    你可使用以下 AI 提示词来创建环境变量文件： ```bash
    创建环境变量文件来存储我的聚合数据 API 密钥 ```
  </TabItem>
  <TabItem label="参考代码">
    ```plaintext JUHE_API_KEY=你的聚合数据API密钥 ```
  </TabItem>
</Tabs>
...
<Tabs>
  <TabItem label="AI提示词">
    你可使用以下 AI 提示词来在 `.gitignore` 中添加环境变量文件： ```bash 在
    `.gitignore` 中添加环境变量文件 ```
  </TabItem>
  <TabItem label="参考代码">
    ```plaintext # 环境变量 .env .env.* !.env.example ```
  </TabItem>
</Tabs>
