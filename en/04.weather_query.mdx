...
// 热门城市
const popularCities = ["北京", "上海", "广州", "深圳", "杭州", "成都", "武汉", "西安"];
...
async function searchCity() {
    ...
    try {
        ...
        const response = await fetch(
            `/api/weather/cities?query=${encodeURIComponent(searchQuery.value)}`,
        );
...
<template>
    <div class="mx-auto max-w-4xl">
        ...
        <div class="form-control mb-8 w-full max-w-lg">
            ...
            <!-- 搜索结果 -->
            <ul v-if="searchResults.length > 0" class="menu bg-base-200 rounded-box mt-2 w-full">
        ...
        <!-- 热门城市 -->
        <div class="mb-8">
            <h2 class="mb-4 text-xl font-bold">热门城市</h2>
